...
def build_report(path: Path) -> Path:
    ...
    _p(
        ...
        "(preview_structure.stl, ansys_layers.json/csv, скрипт импорта в ANSYS, metadata.json) и последующие "
    ...
    _p(
        ...
        "скриншот сеточной модели внутренней структуры (preview_structure.stl) в разрезе, "
    ...
    _p(
        ...
        "preview_structure.stl (сеточная модель восстановленной структуры, предназначенная для визуализации "
        "и последующей конвертации в твердое тело в стороннем ПО); "
    ...
    _p(
        ...
        "сеточной модели (preview_structure.stl) в твердое тело в специализированном ПО с дальнейшим экспортом "
